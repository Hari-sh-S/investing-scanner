...
# Cap-based Indices
NIFTY_MIDCAP_50 = [
    "ADANIPORTS", "ADANITRANS", "GODREJCP", "HAVELLS", "PIIND",
    "DIXON", "PERSISTENT", "TRENT", "LTIM", "POLYCAB",
    # Add more midcap stocks
]

NIFTY_MIDCAP_100 = NIFTY_MIDCAP_50 + [
    "CROMPTON", "ESCORTS", "CUMMINSIND", "IDFCFIRSTB", "RBLBANK"
]

NIFTY_MIDCAP_150 = NIFTY_MIDCAP_100 + [
    "CHAMBLFERT", "DEEPAKNTR", "GLENMARK", "GRANULES", "SYNGENE"
]

NIFTY_SMALLCAP_50 = [
    "IRFC", "IRCTC", "PAYTM", "ZOMATO", "NYKAA"
]

NIFTY_SMALLCAP_100 = NIFTY_SMALLCAP_50 + [
    "ANGELONE", "CDSL", "CAMS", "ROUTE", "MAZDOCK"
]

NIFTY_SMALLCAP_250 = NIFTY_SMALLCAP_100 + [
    "KALYANKJIL", "PCJEWELLER", "SYMPHONY", "RELAXO", "VGUARD"
]

NIFTY_MICROCAP_250 = [
    "RAJESHEXPO", "RICOAUTO", "SKFINDIA", "SUPRAJIT", "TIINDIA"
]
